...
More(Highcharts);
import Annotetions from 'highcharts/modules/annotations';
Annotetions(Highcharts);
...
@Component({
  selector: 'app-linhacomanotacoes',
  templateUrl: './linhacomanotacoes.component.html',
  styleUrls: ['./linhacomanotacoes.component.css']
})
export class LinhacomanotacoesComponent implements OnInit {
  constructor() {}
