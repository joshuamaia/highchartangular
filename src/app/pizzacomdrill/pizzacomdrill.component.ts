...
@Component({
  selector: 'app-pizzacomdrill',
  templateUrl: './pizzacomdrill.component.html',
  styleUrls: ['./pizzacomdrill.component.css']
})
export class PizzacomdrillComponent implements OnInit {
  constructor() {}
